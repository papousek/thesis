...
\subfigure[vývoj systému v čase]{
	\includegraphics[width=.48\textwidth]{../images/lotkav-timeserie.pdf}\label{fig:lotkav:timeserie}
}
\subfigure[stavy, kterými systém prochází]{
	\includegraphics[width=.48\textwidth]{../images/lotkav-oscil.pdf}\label{fig:lotkav:oscil}
}
\end{center}
...
\subfigure[nasimulovaná data]{
	\includegraphics[width=.48\textwidth]{../images/piecewise-constant-a.pdf}
}
\subfigure[po částech konstantní funkce]{
	\includegraphics[width=.48\textwidth]{../images/piecewise-constant-b.pdf}
}
\end{center}
...
\begin{center}
\subfigure[$x \geq k$]{
	\includegraphics[width=.48\textwidth]{../images/stl-example-geq-limit.pdf}\label{fig:stl:example:geq:limit}
}
\subfigure[$x \leq k$]{
	\includegraphics[width=.48\textwidth]{../images/stl-example-leq-limit.pdf}\label{fig:stl:example:leq:limit}
}
\subfigure[$x \geq k \wedge \mathcal{F}_{[0, \frac{1}{2}]}x \leq -k$]{
	\includegraphics[width=.48\textwidth]{../images/stl-example-geq-limit-future-leq-limit.pdf}\label{fig:stl:example:geq:limit:future:leq:limit}
}
\subfigure[$\mathcal{F}_{0, \frac{1}{2}}(x \geq k \wedge \mathcal{F}_{[0, \frac{1}{2}]}x \leq -k)$]{
	\includegraphics[width=.48\textwidth]{../images/stl-example-future-geq-limit-future-leq-limit.pdf}\label{fig:stl:example:future:geq:limit:future:leq:limit}
}
