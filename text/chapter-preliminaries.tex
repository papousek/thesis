...
\begin{center}
\subfigure[$x \geq k$]{
	\includegraphics[width=.48\textwidth]{../images/stl-example-geq-limit.png}\label{fig:stl:example:geq:limit}
}
\subfigure[$x \leq k$]{
	\includegraphics[width=.48\textwidth]{../images/stl-example-leq-limit.png}\label{fig:stl:example:leq:limit}
}
...
\ref{fig:stl:example:geq:limit} a \ref{fig:stl:example:leq:limit}. Jeden cyklus, lze
popsat tak, že se hodnota sledované proměnné nachází nad horní mezí a zároveň někdy
...
\subfigure[$x \geq k \wedge \mathcal{F}_{[0, \frac{1}{2}]}x \leq -k$]{
	\includegraphics[width=.48\textwidth]{../images/stl-example-geq-limit-future-leq-limit.png}\label{fig:stl:example:geq:limit:future:leq:limit}
}
\subfigure[$\mathcal{F}_{0, \frac{1}{2}}(x \geq k \wedge \mathcal{F}_{[0, \frac{1}{2}]}x \leq -k)$]{
	\includegraphics[width=.48\textwidth]{../images/stl-example-future-geq-limit-future-leq-limit.png}\label{fig:stl:example:future:geq:limit:future:leq:limit}
}
\end{center}
\caption{Pravdivostní hodnota složených výroků v čase.}
\end{figure}
